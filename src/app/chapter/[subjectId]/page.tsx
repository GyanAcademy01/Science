    ...
    <main className="mx-auto w-full max-w-[1140px] px-3 py-3 sm:px-5 sm:py-5">
      ...
      <div className="grid gap-3.5 sm:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {subject.topics.map((topic, index) => (
          <div
            key={topic.id}
            className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-[var(--stroke)] bg-[var(--surface)] p-4 sm:p-4.5 min-h-[150px] sm:min-h-[162px] shadow-xl shadow-black/20 dark:shadow-black/70 transition-all duration-300 hover:-translate-y-1.5 hover:border-[var(--stroke-strong)] hover:shadow-2xl hover:shadow-black/30 anim-fade-up"
